...
public interface Constantes {
    static final String DIR_ANALIZADORES = "src/servidorfisql/interpretes/Analizadores/";
    
    static final String DIR_AST_PLYCS = DIR_ANALIZADORES + "PlyCS/analizador/ast/";
